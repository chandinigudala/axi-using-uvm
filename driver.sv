...
class driver extends uvm_driver #(transaction);
 ...
 virtual function void build_phase(uvm_phase phase);
  ...
  task wrrd_fixed_wr();   //write logic in fixed mode
    ...
    task  wrrd_fixed_rd(); // read logic in fixed mode
  ...
  endtask
   ...
   task wrrd_incr_wr(); //write logic in incr mode
    ...
    task wrrd_incr_rd(); // read logic in incr mode
  ...
  endtask
   ...
   task wrrd_wrap_wr();  //write logic in wrap mode
    ...
    task wrrd_wrap_rd(); // read logic inwrap mode
